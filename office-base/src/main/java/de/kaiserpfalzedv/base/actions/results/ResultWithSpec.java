...
/**
 * @param <T> The {@link de.kaiserpfalzedv.base.actions.commands.CommandWithSpec} the result answers.
 * @param <S> The {@link de.kaiserpfalzedv.base.api.Spec} the result worked on.
 * @author rlichti
 * @since 2019-12-15
 */
