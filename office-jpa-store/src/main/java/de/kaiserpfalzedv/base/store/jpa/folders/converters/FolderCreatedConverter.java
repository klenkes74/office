...
import de.kaiserpfalzedv.base.store.jpa.folders.JPAFolderCreate;
import de.kaiserpfalzedv.base.store.jpa.folders.converters.base.ConverterForResultsWithFolderSpec;
...
public class FolderCreatedConverter extends ConverterForResultsWithFolderSpec<FolderCreated, JPAFolderCreate> {
    ...
    public FolderCreated convertToAPI(JPAFolderCreate data) {
        ObjectIdentity identity = createSpecIdentity(data.identity, FolderCreated.KIND, FolderCreated.VERSION);
