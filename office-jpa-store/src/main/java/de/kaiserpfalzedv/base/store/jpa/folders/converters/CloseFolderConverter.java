...
import de.kaiserpfalzedv.base.store.jpa.folders.JPAFolderClose;
import de.kaiserpfalzedv.base.store.jpa.folders.converters.base.ConverterForCommandsWithoutFolderSpec;
...
public class CloseFolderConverter extends ConverterForCommandsWithoutFolderSpec<CloseFolder, JPAFolderClose> {
    ...
    public CloseFolder convertToAPI(JPAFolderClose data) {
        ObjectIdentity identity = createSpecIdentity(data.identity, CloseFolder.KIND, CloseFolder.VERSION);
