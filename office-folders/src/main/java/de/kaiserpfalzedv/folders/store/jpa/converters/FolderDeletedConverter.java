...
import de.kaiserpfalzedv.folders.store.jpa.JPAFolderDelete;
import de.kaiserpfalzedv.folders.store.jpa.converters.base.ConverterForResultsWithoutFolderSpec;
...
public class FolderDeletedConverter extends ConverterForResultsWithoutFolderSpec<FolderDeleted, JPAFolderDelete> {
    ...
    public FolderDeleted convertToAPI(JPAFolderDelete data) {
        ObjectIdentifier identity = createSpecIdentity(data.identity, FolderDeleted.KIND, FolderDeleted.VERSION);
