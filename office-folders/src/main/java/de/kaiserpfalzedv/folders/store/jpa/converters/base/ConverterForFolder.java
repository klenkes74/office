...
package de.kaiserpfalzedv.folders.store.jpa.converters.base;
...
import de.kaiserpfalzedv.folders.store.jpa.JPAFolder;
import de.kaiserpfalzedv.folders.store.jpa.JPAFolderSpec;
...
public abstract class ConverterForFolder<A extends FolderResult, D extends JPAFolder> implements DataConverter<A, D> {
    ...
    private void convertSpec(@NotNull FolderSpec data, D result) {
        ...
        result.spec.displayname = data.getDisplayname().orElse(null);
