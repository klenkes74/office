 ...
 */
@Value.Immutable
@JsonSerialize(as = ImmutableContentRemoved.class)
@JsonDeserialize(builder = ImmutableContentRemoved.Builder.class)
public interface ContentRemoved extends FolderResult {
    String KIND = "de.kaiserpfalzedv.folders.ContentRemoved";
