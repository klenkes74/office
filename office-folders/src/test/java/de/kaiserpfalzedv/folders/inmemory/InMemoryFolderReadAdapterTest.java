...
package de.kaiserpfalzedv.folders.inmemory;
 ...
 */
class InMemoryFolderReadAdapterTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(InMemoryFolderReadAdapterTest.class);
    ...
    private InMemoryFolderReadAdapter service;
    ...
    void setUp() {
        ...
        service = new InMemoryFolderReadAdapter(store);
    ...
    void shouldPrintAValidStringRepresentation() {
        ...
        assertThat(service.toString(), matchesRegex("InMemoryFolderReadAdapter\\[identity=[0-9]+, store=.*"));
    }
