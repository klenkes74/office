...
/**
 * @author rlichti
 * @since 2020-01-01T19:45
 */
@Value.Immutable
@JsonSerialize(as = ImmutableOidcScope.class)
@JsonDeserialize(builder = ImmutableOidcScope.Builder.class)
public interface OidcScope extends Serializable, IdentityHolding, DisplaynameHolding, IconUriHolding {
}
