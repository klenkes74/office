...
public interface NaturalPersonModified extends NaturalPersonResult, SpecHolding<NaturalPersonSpec> {
    String KIND = "de.kaiserpfalzedv.contacts.NaturalPersonModified";
