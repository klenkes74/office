 ...
 */
@Value.Immutable
@JsonSerialize(as = ImmutableNaturalPersonData.class)
@JsonDeserialize(builder = ImmutableNaturalPersonData.Builder.class)
public interface NaturalPersonData extends PersonData {
