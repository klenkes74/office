 ...
 */
@Value.Immutable
@JsonSerialize(as = ImmutableConvention.class)
@JsonDeserialize(builder = ImmutableConvention.Builder.class)
public interface Convention extends SingleObject<ConventionSpec> {
