...
@JsonDeserialize(builder = ImmutableTopic.Builder.class)
public interface Topic extends SingleObject<TopicSpec>, Comparable<Topic> {
    String KIND = "de.kaiserpfalzedv.conventions.content.Topic";
